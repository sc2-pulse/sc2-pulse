...
DROP TYPE IF EXISTS "league_tier_type" CASCADE;
...
DROP TABLE IF EXISTS "map_stats_film_spec" CASCADE;
DROP TABLE IF EXISTS "map_stats_film" CASCADE;
DROP TABLE IF EXISTS "map_stats_film_frame" CASCADE;
...
DROP TABLE IF EXISTS "team_state_archive" CASCADE;
...
DROP TABLE IF EXISTS "ladder_update" CASCADE;
