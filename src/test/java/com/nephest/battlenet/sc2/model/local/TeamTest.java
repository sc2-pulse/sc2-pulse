...
public class TeamTest
{
    ...
    public void testUniqueness()
    {
        ...
        Team team = new Team
        (0L, 0, Region.EU, equalLeague, FIRST, 0, BigInteger.valueOf(0), 0L, 0, 0, 0, 0
        );
        Team equalTeam = new Team
        (1L, 0, Region.EU, mock(League.class), SECOND, 1, BigInteger.valueOf(0), 1L, 1, 1, 1, 1
        );
        ...
        {
            new Team
            (0L, 1, Region.US, equalLeague, FIRST, 0, BigInteger.valueOf(1), 0L, 0, 0, 0, 0
            )
        };
