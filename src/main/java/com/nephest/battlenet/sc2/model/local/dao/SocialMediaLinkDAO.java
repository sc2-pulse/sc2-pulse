...
public class SocialMediaLinkDAO
{
    ...
    private static final String CREATE_QUERY =
        "INSERT INTO social_media_link (pro_player_id, type, url, updated) VALUES(:proPlayerId, :type, :url, :updated)";
    ...
    {
        if(STD_ROW_MAPPER == null) STD_ROW_MAPPER = (rs, ix)->
        {
            ...
            link.setUpdated(rs.getObject("social_media_link.updated", OffsetDateTime.class));
            return link;
        };
