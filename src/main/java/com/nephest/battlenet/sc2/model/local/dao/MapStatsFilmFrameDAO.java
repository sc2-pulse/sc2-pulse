    ...
    private static final String ADD =
        ...
        + "(\n"
            ...
            + "array_agg(get_top_percentage_league_tier_lotv("
                + "region_rank, region_team_count, true))::league_tier_type[] AS league_tier,\n"
        ...
        + "(\n"
            ...
            + "SUM(wins) AS wins,\n"
            + "cross_tier\n"
            + "FROM stats_group_union\n"
            + "GROUP BY map_id, matchup, region, season, league, tier, duration_ix, cross_tier\n"
        + "),\n"
        + "film_group AS\n"
        + "(\n"
            + "SELECT map_id,\n"
