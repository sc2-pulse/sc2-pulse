...
public class QueueStatsDAO
{
    private static final String CALCULATE_SEASON_PLAYER_BASE_QUERY =
        ...
        + "(season, queue_type, team_type, player_base) "
        + "SELECT count_all.team_season, count_all.team_queue_type, count_all.team_team_type, count_all.player_base "
        + "FROM count_all "
    ...
    public void calculateForSeason(long season)
    {
        ...
        template.update(CALCULATE_SEASON_PLAYER_BASE_QUERY, params);
    }
