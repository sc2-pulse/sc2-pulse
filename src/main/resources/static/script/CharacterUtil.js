...
class CharacterUtil
{
    ...
    {
        return CharacterUtil.MMR_HISTORY.enqueueUpdateHistoryAll();
    }
    ...
    static afterEnhance()
    {
        MmrHistory.setYAxis(document.getElementById("mmr-y-axis").value,
...
CharacterUtil.MMR_HISTORY = new MmrHistory
(
    "mmr",
    CharacterUtil.getCharacterMmrQueueData,
    ()=>Model.DATA.get(VIEW.CHARACTER).get(VIEW_DATA.VAR).members.character.region,
    CharacterUtil.getMmrHistoryTeamName,
    "Race",
    legacyUidData=>ElementUtil.createRaceImage(legacyUidData.legacyId.entries[0].race)
);
